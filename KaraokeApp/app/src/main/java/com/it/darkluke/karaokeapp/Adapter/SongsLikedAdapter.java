...
public class SongsLikedAdapter extends RecyclerView.Adapter<SongsLikedAdapter.SongRecyclerViewHolder> {

    ArrayList<Song> listData = new ArrayList<>();
    ArrayList<Song> listDataCopy = new ArrayList<>();

    public SongsLikedAdapter(ArrayList<Song> listData) {
        this.listData = listData;
        listDataCopy.addAll(listData);
    }

    @Override
    public SongsLikedAdapter.SongRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View itemView = inflater.inflate(R.layout.item_song, parent, false);
        return new SongsLikedAdapter.SongRecyclerViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(SongsLikedAdapter.SongRecyclerViewHolder holder, int position) {
